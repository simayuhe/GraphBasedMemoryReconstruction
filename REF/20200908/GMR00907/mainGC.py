...
def main(argv=()):
    ...
    #plt.show()
    plt.savefig("./RESULT/GCQ/reward_list005.png")
    reward_list=np.array(reward_list)
    np.save('./RESULT/GCQ/reward_list005.npy',reward_list)
    temp_step_r=[]
    ...
    #plt.show()
    plt.savefig("./RESULT/GCQ/step_r005.png")
    temp_step_r=np.array(temp_step_r)
    np.save('./RESULT/GCQ/temp_step_r005.npy',temp_step_r)
